 ...
 *
 */
if (!function_exists('azrcrv_create_plugin_menu_ti')){
	function azrcrv_create_plugin_menu_ti(){
		azrcrv_create_plugin_menu_table_ti();
		azrcrv_populate_plugin_menu_table_ti();
	}
}
 ...
 *
 */
if (!function_exists('azrcrv_populate_plugin_menu_table_ti')){
	function azrcrv_populate_plugin_menu_table_ti(){
		global $wpdb;
 ...
 *
 */
if (!function_exists('azrcrv_create_plugin_menu_table_ti')){
	function azrcrv_create_plugin_menu_table_ti(){
		global $wpdb;
		$table_name = $wpdb->base_prefix.'azrcrv_plugin_menu';
